...
# Simple Linear Regression with Estimated Employed
lm_model <- lm(`Estimated Unemployment Rate` ~ `Estimated.Employed`, data =data)
lm_model
plot(lm_model)

# Visualizing the regression line of estimated employment on unemployment
ggplot(data, aes(x = `Estimated.Employed`, y = `Estimated Unemployment Rate`)) +
  geom_point() +
  geom_smooth(method = "lm", se = FALSE, color = "blue") +
  labs(title = "Linear Regression: Unemployment Rate vs Estimated Employed",
       x = "Estimated Employed", y = "Estimated Unemployment Rate")
